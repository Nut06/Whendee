...
export default function SetLocationScreen() {
  ...
  const [eventTitle] = useState<string>(title ?? "");
  ...
  const handleSave = () => {
    ...
    // NOTE: original code referenced meetingId; using eventId here
    planStore.addCandidate(String(eventId), displayName);

    router.push({
      pathname: "/(main)/vote/vote-location" as any,
      params: { meetingId: String(eventId) },
    });
  };
