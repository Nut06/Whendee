...
export default function ScheduleMeeting({ onSave, onCancel }: Props) {
  ...
  const [dateText, setDateText] = useState("12 Sep' 23");
  const [repeat, setRepeat] = useState("All Days");
  const [budget, setBudget] = useState("5000 ฿");
  const [alert, setAlert] = useState("15 min before");
    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.body}>
          ...
          <TouchableOpacity
            style={styles.row}
            onPress={() => router.push("/(main)/addMember")}
          >
            <View style={styles.rowLeft}>
